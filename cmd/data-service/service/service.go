...
func NewService(
	sd serviced.Service, ssd serviced.ServiceDiscover,
	daoSet dao.Set, vaultSet vault.Set,
	esb client.Client, repo repository.Provider,
	taskManager *task.TaskManager) (*Service, error) {
