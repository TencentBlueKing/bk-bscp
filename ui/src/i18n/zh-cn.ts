export default {
  ...
  外部数据源: '外部数据源',
  新建表格: '新建表格',
  '表格名称/表格描述/最近更新人': '表格名称/表格描述/最近更新人',
  表格名称: '表格名称',
  表格描述: '表格描述',
  关联配置项: '关联配置项',
  最近更新人: '最近更新人',
  ...
  实际值: '实际值',
  字段名: '字段名',
  '字段名包含字母、数字、下划线 ( _ ) 和美元符号 ( $ )，长度不超过 64 字符': '字段名包含字母、数字、下划线 ( _ ) 和美元符号 ( $ )，长度不超过 64 字符',
  显示名: '显示名',
  '默认值/枚举值': '默认值/枚举值',
  主键: '主键',
  非空: '非空',
  ...
  文件来源: '文件来源',
  选择文件: '选择文件',
  '支持 .xlsx / .xls / .csv / .sql 文件，后台会自动检测文件类型，配置项格式请参照': '支持 .xlsx / .xls / .csv / .sql 文件，后台会自动检测文件类型，配置项格式请参照',
  表结构来源: '表结构来源',
  手动创建表结构: '手动创建表结构',
  '目前没有表格结构及数据信息，需要先手动创建表结构，然后手动录入数据': '目前没有表格结构及数据信息，需要先手动创建表结构，然后手动录入数据',
  从本地文件导入: '从本地文件导入',
  '可以从本地导入 Excel/CSV 格式的数据文件（.xlsx/.xls/.csv)，还可以从带有 .sql 后缀的 MySQL dump 文件中导入表结构与数据': '可以从本地导入 Excel/CSV 格式的数据文件（.xlsx/.xls/.csv)，还可以从带有 .sql 后缀的 MySQL dump 文件中导入表结构与数据',
  工作表: '工作表',
  正在匹配表格字段: '正在匹配表格字段',
  '表格字段匹配，可继续导入': '表格字段匹配，可继续导入',
  '表格字段有差异，请先确认调整': '表格字段有差异，请先确认调整',
  导入前清空原有数据: '导入前清空原有数据',
  '主键校验：': '主键校验：',
  '当导入表的主键值出现重合，将直接':'当导入表的主键值出现重合，将直接',
  使用导入表的数据覆盖: '使用导入表的数据覆盖',
  '字段校验：':'字段校验：',
  '导入表删除字段后将更新表结构，该字段':'导入表删除字段后将更新表结构，该字段',
  已有数据也将同时被清空: '已有数据也将同时被清空',
  批量设置字段值: '批量设置字段值',
  常用查询: '常用查询',
  基础查询: '基础查询',
  高级查询: '高级查询',
  导出: '导出',
  '可设置字段默认值；ENUM 类型请设置枚举值':'可设置字段默认值；ENUM 类型请设置枚举值',
  请先添加字段: '请先添加字段',
  新建表格成功: '新建表格成功',
  编辑表格成功: '编辑表格成功',
  编辑数据成功: '编辑数据成功',
  删除表格成功: '删除表格成功',
  重新上传文件: '重新上传文件',
  '显示名重名，请修改源文件后重新上传': '显示名重名，请修改源文件后重新上传',
};
