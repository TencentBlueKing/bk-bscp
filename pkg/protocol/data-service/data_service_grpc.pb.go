...
const (
	...
	Data_UpdateTableContent_FullMethodName                = "/pbds.Data/UpdateTableContent"
...
func (c *dataClient) UpdateTableContent(ctx context.Context, in *UpdateTableContentReq, opts ...grpc.CallOption) (*UpdateTableContentResp, error) {
	out := new(UpdateTableContentResp)
	err := c.cc.Invoke(ctx, Data_UpdateTableContent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDataServer) UpdateTableContent(context.Context, *UpdateTableContentReq) (*UpdateTableContentResp, error) {
...
func _Data_UpdateTableContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTableContentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataServer).UpdateTableContent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Data_UpdateTableContent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataServer).UpdateTableContent(ctx, req.(*UpdateTableContentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Data_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Data_UpdateTableContent_Handler,
		},
		{
