...
const (
	...
	Config_UpdateTableContent_FullMethodName                 = "/pbcs.Config/UpdateTableContent"
...
type ConfigClient interface {
	...
	// 编辑表数据
	UpdateTableContent(ctx context.Context, in *UpdateTableContentReq, opts ...grpc.CallOption) (*UpdateTableContentResp, error)
	// 获取表数据列表
...
func (c *configClient) UpdateTableContent(ctx context.Context, in *UpdateTableContentReq, opts ...grpc.CallOption) (*UpdateTableContentResp, error) {
	out := new(UpdateTableContentResp)
	err := c.cc.Invoke(ctx, Config_UpdateTableContent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConfigServer interface {
	...
	// 编辑表数据
	UpdateTableContent(context.Context, *UpdateTableContentReq) (*UpdateTableContentResp, error)
	// 获取表数据列表
...
func (UnimplementedConfigServer) UpdateTableContent(context.Context, *UpdateTableContentReq) (*UpdateTableContentResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTableContent not implemented")
}
...
func _Config_UpdateTableContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTableContentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigServer).UpdateTableContent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Config_UpdateTableContent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServer).UpdateTableContent(ctx, req.(*UpdateTableContentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Config_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTableContent",
			Handler:    _Config_UpdateTableContent_Handler,
		},
		{
