...
func PbDataSourceMapping(c *table.DataSourceMapping, citations int64) *DataSourceMapping {
	if c == nil {
		return nil
	}
...
func PbDataSourceMappings(c []*table.DataSourceMapping, citations map[uint32]int64) []*DataSourceMapping {
	if c == nil {
