...
type DataSourceMapping struct {
	...
	Citations  int64                        `protobuf:"varint,5,opt,name=citations,proto3" json:"citations,omitempty"`
}
...
func (x *DataSourceMapping) GetCitations() int64 {
	if x != nil {
		return x.Citations
	}
	return 0
...
var file_data_source_mapping_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x42, 0x1a, 0x92, 0x41, 0x17, 0x32,
