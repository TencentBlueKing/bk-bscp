...
var (
	...
	listServiceInstanceBySetTemplate = "%s/api/bk-cmdb/prod/api/v3/findmany/proc/service/set_template/list_service_instance/biz/%d"
...
func (bkcmdb *CMDBService) FindHostByTopo(ctx context.Context, req FindHostByTopoReq) (*CMDBResponse[CMDBListData[FindHostByTopo]], error) {
...
func (bkcmdb *CMDBService) SearchBizInstTopo(ctx context.Context, req SearchBizInstTopoReq) (*CMDBResponse[SearchBizInstTopo], error) {
...
func (bkcmdb *CMDBService) GetServiceTemplate(ctx context.Context, req GetServiceTemplateReq) (*CMDBResponse[GetServiceTemplate], error) {
...
func (bkcmdb *CMDBService) ListServiceTemplate(ctx context.Context, req ListServiceTemplateReq) (*CMDBResponse[CMDBListData[ListServiceTemplate]], error) {
...
func (bkcmdb *CMDBService) GetProcTemplate(ctx context.Context, req GetProcTemplateReq) (*CMDBResponse[ProcTemplate], error) {
...
func (bkcmdb *CMDBService) ListProcTemplate(ctx context.Context, req ListProcTemplateReq) (*CMDBResponse[CMDBListData[ProcTemplate]], error) {
...
func (bkcmdb *CMDBService) ListProcessInstance(ctx context.Context, req ListProcessInstanceReq) (*CMDBResponse[CMDBListData[ListProcessInstance]], error) {
...
func (bkcmdb *CMDBService) FindHostBySetTemplate(ctx context.Context, req FindHostBySetTemplateReq) (*CMDBResponse[CMDBListData[HostInfo]], error) {
...
func (bkcmdb *CMDBService) ListSetTemplate(ctx context.Context, req ListSetTemplateReq) (*CMDBResponse[CMDBListData[ClusterTemplateInfo]], error) {
...
func (bkcmdb *CMDBService) ListProcessDetailByIds(ctx context.Context, req ProcessRequest) (*CMDBResponse[CMDBListData[ProcessInfo]], error) {
...
func (bkcmdb *CMDBService) ListServiceInstanceBySetTemplate(ctx context.Context, req ServiceInstanceRequest) (*CMDBResponse[CMDBListData[ServiceInstanceInfo]], error) {
...
func (bkcmdb *CMDBService) FindModuleBatch(ctx context.Context, req ServiceInstanceRequest) (*CMDBResponse[CMDBListData[ServiceInstanceInfo]], error) {
